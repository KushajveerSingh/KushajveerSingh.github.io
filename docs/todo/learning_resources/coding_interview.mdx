...
-   Books
    ...
    -   Capacity Planning
        ...
        -   A-Z of Capacity Management: Practical Guide for Implementing Enterprise IT Monitoring & Capcity Planning
...
-   (book) [SQL Performance Exaplined](https://use-the-index-luke.com/)
-   (book) [SQL Antipatterns volume 1](https://trello.com/c/dftJnWvD/32-book-sql-antipatterns-volume-1)
