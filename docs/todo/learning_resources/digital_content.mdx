...
-   [Affinity Revoluion](https://courses.affinityrevolution.com/) courses
    -   Affininty Photo for Begineers
...
-   [Offical Training](https://www.blackmagicdesign.com/products/davinciresolve/training)
    -   (Book) Begineer's Guide to Davinci Resolve
    -   Edit
...
-   (sculting or detail modeling) [ZBrush](https://www.maxon.net/en/zbrush)
-   (real time 3d rendere) [Unreal Engine](https://www.unrealengine.com/en-US)
