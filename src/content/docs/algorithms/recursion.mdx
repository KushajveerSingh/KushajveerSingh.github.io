...
**How to solve recursive problem?** Build the *recursive tree* and then convert it to code.

General idea behind recursive tree

<ImageCaption src={Image_recursion_input_output} alt="How to build recursive tree" />
