...
-   Add single character labels to side of line markers to help with referencing specific parts of code.
    ...
    ```jsx title="labeled-line-markers.jsx" {"1":4} del={"2":6-7} ins={"3":9-11}
    <button
        role='button'
        {...props}
        value={value}
...
[Instruction](https://starlight.astro.build/guides/css-and-tailwind/#theming) to create personal theme.
