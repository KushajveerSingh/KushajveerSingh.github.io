...
### VSCode
Install [Astro](https://marketplace.visualstudio.com/items?itemName=astro-build.astro-vscode) extenstion.
...
Install [ESLint](https://marketplace.visualstudio.com/items?itemName=dbaeumer.vscode-eslint) extenstion for VSCode and modify the `.vscode/settings.json` file
```json
{
  "eslint.validate": [
    "javascript",
...
### Deploy
Complete instructions at https://docs.astro.build/en/guides/deploy/.
